...
export function App() {
  ...
  const terrainSource = useMemo(() => tab.style.viewMode === "3d" ? new TerrainLayer({ id: "terrain-source", elevationData: terrainTiles, elevationDecoder: terrainDecoder, minZoom: 0, maxZoom: 15, strategy: "no-overlap", operation: "terrain" }) : null, [tab.style.viewMode]);
