...
The upload view polls the persisted processing state, so completion is visible without requiring users to verify an email address with an infrastructure provider.
